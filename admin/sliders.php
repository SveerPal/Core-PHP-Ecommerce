...
<div class="wrapper">
  ...
  <div class="content-wrapper">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      $stmt->execute();
                      foreach($stmt as $row){
                        $image = (!empty($row['photo'])) ? 'uploaded_files/sliders/'.$row['photo'] : '../images/profile.jpg';
    ...
    <?php include 'includes/sliders/sliders_modal.php'; ?>
...
$('#addForm').on('submit',function(e) {
    ...
    $.ajax({
      type: 'POST',
      url: 'includes/sliders/sliders_ajax.php',
      data: formData,
      dataType: 'json',
      contentType: false,
      processData: false,
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'includes/sliders/sliders_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      ...
      $('#edit_heading_1').val(response.heading_1);
      $('#edit_heading_2').val(response.heading_2);
