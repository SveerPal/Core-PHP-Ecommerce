  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Products Brands</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $i=1;
                    try{
                      $stmt = $conn->prepare("SELECT * FROM products_brands");
                      $stmt->execute();
                      $prtncatlist="";
                      foreach($stmt as $row){
    ...
    <?php include 'includes/products_brands/brands_modal.php'; ?>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'includes/products_brands/brands_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('.id').val(response.id);
