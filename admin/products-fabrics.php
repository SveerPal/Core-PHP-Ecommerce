...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Products Fabrics</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Products Fabrics</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $i=1;
                    try{
                      $stmt = $conn->prepare("SELECT * FROM products_fabrics");
                      $stmt->execute();
                      $prtncatlist="";
                      foreach($stmt as $row){
    ...
    <?php include 'includes/products_fabrics/fabrics_modal.php'; ?>
...
$('#addForm').on('submit',function(e) {
    ...
    $.ajax({
      type: 'POST',
      url: 'includes/products_fabrics/fabrics_ajax.php',
      data: formData,
      dataType: 'json',
      contentType: false,
      processData: false,
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'includes/products_fabrics/fabrics_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('.id').val(response.id);
