  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Products Color</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $i=1;
                    try{
                      $stmt = $conn->prepare("SELECT * FROM products_color");
                      $stmt->execute();
                      $prtncatlist="";
                      foreach($stmt as $row){
    ...
    <?php include 'includes/products-color/color_modal.php'; ?>
...
$('#addForm').on('submit',function(e) {
    ...
    $.ajax({
      type: 'POST',
      url: 'includes/products-color/color_ajax.php',
      data: formData,
      dataType: 'json',
      contentType: false,
      processData: false,
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'includes/products-color/color_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('.id').val(response.id);
