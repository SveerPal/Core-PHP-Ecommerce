...
<div class="wrapper">
  ...
  <div class="content-wrapper">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      $stmt->execute();
                      foreach($stmt as $row){
                        $image = (!empty($row['photo'])) ? 'uploaded_files/galleries/'.$row['photo'] : '../images/profile.jpg';
    ...
    <?php include 'includes/galleries/galleries_modal.php'; ?>
...
$('#addForm').on('submit',function(e) {
    ...
    $.ajax({
      type: 'POST',
      url: 'includes/galleries/galleries_ajax.php',
      data: formData,
      dataType: 'json',
      contentType: false,
      processData: false,
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'includes/galleries/galleries_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
