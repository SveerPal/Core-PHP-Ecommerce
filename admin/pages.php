        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="pages-add.php" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> New</a>
            </div>
            <div class="box-body">
                  ...
                  <?php
                    ...
                    try{
                      ...
                      foreach($stmt as $row){
                        $image="";
                        if(!empty($row['photo'])) {
                          $image="<img src='uploaded_files/pages/".$row['photo']."' height='30px' width='30px'>";
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              <a href='pages-edit.php?page-id=".$row['id']."' class='btn btn-success btn-sm btn-flat' data-id='".$row['id']."'><i class='fa fa-edit'></i> Edit</a>
