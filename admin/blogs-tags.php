...
<div class="wrapper">
  ...
  <div class="content-wrapper">
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $i=1;
                    try{
                      $stmt = $conn->prepare("SELECT * FROM blogs_tags");
                      $stmt->execute();
                      $prtncatlist="";
                      foreach($stmt as $row){
    ...
    <?php include 'includes/blogs-tags/tags_modal.php'; ?>
...
$('#addForm').on('submit',function(e) {
    ...
    $.ajax({
      type: 'POST',
      url: 'includes/blogs-tags/tags_ajax.php',
      data: formData,
      dataType: 'json',
      contentType: false,
      processData: false,
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'includes/blogs-tags/tags_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('.id').val(response.id);
