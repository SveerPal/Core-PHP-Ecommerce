        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" id="editForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">Status</label>

                    <div class="col-sm-9">
                      <div class="radioe">
                         <label for="edit_status1">
                             <input type="radio" id="edit_status1" name="status" value="1"> Yes
                         </label>
                         <label for="edit_status0">
                             <input type="radio" id="edit_status0" name="status" value="0"> No
                          </label>
