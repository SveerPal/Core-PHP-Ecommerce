        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="heading_1" class="col-sm-3 control-label">Heading First</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="heading_1" name="heading_1">
                    </div>
                </div>
                <div class="form-group">
                    <label for="heading_2" class="col-sm-3 control-label">Heading Second</label>
                    <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" id="editForm">
                ...
                <div class="form-group">
                    <label for="edit_heading_1" class="col-sm-3 control-label">Heading First</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_heading_1" name="heading_1">
                    </div>
                </div>
                <div class="form-group">
                    <label for="edit_heading_2" class="col-sm-3 control-label">Heading Second</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_heading_2" name="heading_2">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="edit_label" class="col-sm-3 control-label">Label</label>
                    <div class="col-sm-9">
