<?php 
if(!isset($_GET['page-id']) || $_GET['page-id']==''){
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
    $pageid=$_GET['page-id'];
    $pageDetails=$SettingsData->getPageDetail($pageid);
      ...
      <div class="row">
        <div class="col-xs-12">
          <form class="form-inlinee" method="POST" id="editForm" enctype="multipart/form-data">
            <input type="hidden" name="page_id" value="<?php echo $pageDetails['id']; ?>"> 
            <div class="box">
              ...
              <div class="box-body">
                    ...
                    <div class="col-sm-12">
                      <select name="templates" id="templates" class="form-control required">
                        ...
                        foreach($templates as $key=>$value){ 
                          $selected = '';
                          if($pageDetails['templates'] == $value)
                            $selected = 'Selected';
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-12">
                    <input value="<?php echo $pageDetails['name']; ?>" type="text" class="form-control" id="name" name="name" required>
                    </div>
                  </div>
                  <div class="form-group col-sm-6">
                    <label for="slug" class="col-sm-12 control-label">Slug</label>
                    <div class="col-sm-12">
                    <input value="<?php echo $pageDetails['slug']; ?>" type="text" class="form-control" id="slug" name="slug" >
                    </div>
                  </div>
                  <div class="form-group col-sm-6">
                    <label for="breadcrumb" class="col-sm-12 control-label">Breadcrumb</label>
                    <div class="col-sm-12">
                      <input value="<?php echo $pageDetails['breadcrumb']; ?>" type="text" class="form-control" id="breadcrumb" name="breadcrumb" >
                    </div>
                  </div>
                  <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-12">  
                      <select class="form-control select2" id="parent" name="parent">
                        ...
                        <?php $SettingsData->pageTreeEdit($parent_id = 0, $sub_mark = '',$pageDetails['parent'],$pageDetails['id']);?>
                      </select>                      
                    </div>
                  </div>
                  <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-12">
                    <textarea class="form-control editor1" id="description" name="description"><?php echo stripslashes($pageDetails['description']); ?></textarea>
                    </div>
                  </div> 
                  <div class="form-group col-sm-12">
                    <label for="additional_description" class="col-sm-12 control-label">Additional Description</label>
                    <div class="col-sm-12">
                    <textarea class="form-control" id="additional_description" name="additional_description"><?php echo $pageDetails['additional_description']; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group  col-sm-6">
                    ...
                    <div class="col-sm-12">
                      ...
                      <input type="hidden" id="photo_old" name="photo_old" class="form-control" value="<?php echo $pageDetails['photo']; ?>">
                      <?php 
                        if($pageDetails['photo']){
                          echo "<img src='uploaded_files/pages/". $pageDetails['photo'] ."' height='50' >";
                        }
                      ?>
                    </div>
                  </div>                        
                  <div class="form-group  col-sm-6">
                    ...
                    <div class="col-sm-12">
                    <input value="<?php echo $pageDetails['alt']; ?>" type="text" class="form-control" id="alt" name="alt">
                    </div>
                  </div> 
                  <div class="form-group col-sm-6">
                      <label for="banner_heading" class="col-sm-12 control-label">Banner Heading</label>
                      <div class="col-sm-12">
                        <input type="text" value="<?php echo $pageDetails['banner_heading']; ?>" class="form-control" id="banner_heading" name="banner_heading">
                      </div>
                  </div>
                  <div class="form-group col-sm-6">
                      <label for="banner_description" class="col-sm-12 control-label">Banner Description</label>
                      <div class="col-sm-12">
                        <input type="text" value="<?php echo $pageDetails['banner_description']; ?>" class="form-control" id="banner_description" name="banner_description">
                      </div>
                  </div>
                  <div class="form-group col-sm-6">
                      <label for="banner_label" class="col-sm-12 control-label">Banner Label</label>
                      <div class="col-sm-12">
                        <input type="text" value="<?php echo $pageDetails['banner_label']; ?>" class="form-control" id="banner_label" name="banner_label">
                      </div>
                  </div>
                  <div class="form-group col-sm-6">
                      <label for="banner_url" class="col-sm-12 control-label">Banner URL</label>
                      <div class="col-sm-12">
                        <input type="text" value="<?php echo $pageDetails['banner_url']; ?>" class="form-control" id="banner_url" name="banner_url">
                      </div>
                  </div>          
                  <div class="form-group  col-sm-6">
                    <label for="meta_title" class="col-sm-12 control-label">Meta Title</label>
                    <div class="col-sm-12">
                    <input value="<?php echo $pageDetails['meta_title']; ?>" type="text" class="form-control" id="meta_title" name="meta_title">
                    </div>
                  </div>
                  <div class="form-group  col-sm-6">
                    <label for="meta_keyword" class="col-sm-12 control-label">Meta Keywords</label>
                    <div class="col-sm-12">
                    <input value="<?php echo $pageDetails['meta_keyword']; ?>" type="text" class="form-control" id="meta_keyword" name="meta_keyword">
                    </div>
                  </div> 
                  <div class="form-group  col-sm-12">
                    <label for="meta_description" class="col-sm-12 control-label">Meta Description</label>
                    <div class="col-sm-12">
                    <textarea class="form-control" id="meta_description" name="meta_description"> <?php echo $pageDetails['meta_description']; ?></textarea>
                    </div>
                  </div>  
                  <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-12">
                      <div class="radio">
                        <label for="edit_status1">
                          <input type="radio" name="status" class="status" id="edit_status1" value="1" <?php if($pageDetails['status']==1){ ?>checked<?php } ?> >Yes
                        </label>&nbsp;
                        <label for="edit_status0">
                          <input type="radio" name="status" class="status" id="edit_status0" value="0" <?php if($pageDetails['status']==0){ ?>checked<?php } ?>>No
                        </label>
                      </div>                      
                    </div>
                  </div>                    
