        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="products-add.php" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> New</a>
            </div>
            <div class="box-body">
                  ...
                  <?php
                    ...
                    try{
                      ...
                      foreach($stmt as $row){
                        $image="";
                        if(!empty($row['photo'])) {
                          $image="<img src='uploaded_files/products/".$row['photo']."' height='30px' width='30px'>";
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              <a href='products-edit.php?product-id=".$row['id']."' class='btn btn-success btn-sm btn-flat' data-id='".$row['id']."'><i class='fa fa-edit'></i> Edit</a>
