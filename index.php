            ...
            <div class="container-fluid">
                <div class="banner__discount--inner position__relative">
                    <div class="row row-cols-sm-2 row-cols-1">
                        <div class="col">
                            <div class="banner__items banner__discount--items position__relative">
                                <a class="banner__items--thumbnail " href="javascript:void(0)"><img class="banner__items--thumbnail__img" src="assets/img/banner/left.jpg" alt="banner-img"></a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="banner__items banner__discount--items position__relative">
                                <a class="banner__items--thumbnail " href="javascript:void(0)"><img class="banner__items--thumbnail__img" src="assets/img/banner/right.jpg" alt="banner-img"></a>
                            </div>
                        </div>
                    </div>
                    <div class="banner__discount--content text-center">
                        <span class="banner__discount--content__subtitle">Summer Collection <?php echo date('Y');?></span>
                        <h2 class="banner__discount--content__title h3">THE JOURNEY OF AL PASBAN SHOP BEGINS A NEW ROAD WITH THE SUPPORT OF ITS <br>
                            CUSTOMERS.</h2>
                        <a class="banner__discount--content__link" href="<?php echo SITE_URL ;?>shop.html">SHOP NOW</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="new__product--sidebar position__relative">
                            <div class=" product__swiper--column3 swiper">
                                <div class="swiper-wrapper">
                                    <?php 
                                    $newarrivalproducts=$FontEndData->getProductListCategory(16,5);
                                        ...
                                        <div class="new__product--items">
                                            <div class="new__product--thumbnail">
                                                <a class="new__product--thumbnail__link" href="<?php echo SITE_URL;?>product/<?php echo $newarrivalproduct['slug'];?>.html">
                                                    <img width="298" height="447" class="new__product--thumbnail__img" src="<?php echo UPLOADS.'products/'.$newarrivalproduct['photo']; ?>" alt="<?php echo $newarrivalproduct['name']; ?>">
                                                </a>
                                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items--style2 testimonial__items text-center">
                                <div class="testimonial__items--style2__thumbnail mb-10">
                                    <img width="86" height="86" class="testimonial__items--style2__thumbnail--img border-radius-50" src="<?php echo UPLOADS.'testimonials/'.$testimonial['photo']; ?>" alt="<?php echo $testimonial['name']; ?>">
                                </div>
